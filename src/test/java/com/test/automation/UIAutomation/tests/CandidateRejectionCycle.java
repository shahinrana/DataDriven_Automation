...
public class CandidateRejectionCycle extends TestBase {

	public static Logger log = Logger.getLogger(CandidateRejectionCycle.class.getName());
	public static String requirementList;
